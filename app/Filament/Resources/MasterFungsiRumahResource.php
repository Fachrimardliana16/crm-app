...
use App\Filament\Resources\MasterFungsiRumahResource\Pages;
use App\Filament\Resources\MasterFungsiRumahResource\RelationManagers;
...
class MasterFungsiRumahResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Fungsi Rumah';
    ...
    {
        return [
            'index' => Pages\ListMasterFungsiRumahs::route('/'),
            'create' => Pages\CreateMasterFungsiRumah::route('/create'),
            'edit' => Pages\EditMasterFungsiRumah::route('/{record}/edit'),
        ];
    }
}
