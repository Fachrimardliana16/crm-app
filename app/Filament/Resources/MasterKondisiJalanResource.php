...
use App\Filament\Resources\MasterKondisiJalanResource\Pages;
use App\Filament\Resources\MasterKondisiJalanResource\RelationManagers;
...
class MasterKondisiJalanResource extends Resource
{
    protected static ?string $model = MasterKondisiJalan::class;
    ...
    {
        return [
            'index' => Pages\ListMasterKondisiJalans::route('/'),
            'create' => Pages\CreateMasterKondisiJalan::route('/create'),
            'edit' => Pages\EditMasterKondisiJalan::route('/{record}/edit'),
        ];
    }
}
