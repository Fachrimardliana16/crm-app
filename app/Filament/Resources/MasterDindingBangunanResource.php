...
use App\Filament\Resources\MasterDindingBangunanResource\Pages;
use App\Filament\Resources\MasterDindingBangunanResource\RelationManagers;
...
class MasterDindingBangunanResource extends Resource
{
    protected static ?string $model = MasterDindingBangunan::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationGroup = 'Master Data';

    protected static ?string $navigationLabel = 'Dinding Bangunan';
    ...
    {
        return [
            'index' => Pages\ListMasterDindingBangunans::route('/'),
            'create' => Pages\CreateMasterDindingBangunan::route('/create'),
            'edit' => Pages\EditMasterDindingBangunan::route('/{record}/edit'),
        ];
    }
}
