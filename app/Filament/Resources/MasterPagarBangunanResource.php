...
use App\Filament\Resources\MasterPagarBangunanResource\Pages;
use App\Filament\Resources\MasterPagarBangunanResource\RelationManagers;
...
class MasterPagarBangunanResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pagar Bangunan';
    ...
    {
        return [
            'index' => Pages\ListMasterPagarBangunans::route('/'),
            'create' => Pages\CreateMasterPagarBangunan::route('/create'),
            'edit' => Pages\EditMasterPagarBangunan::route('/{record}/edit'),
        ];
    }
}
