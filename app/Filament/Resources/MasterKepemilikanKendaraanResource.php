...
use App\Filament\Resources\MasterKepemilikanKendaraanResource\Pages;
use App\Filament\Resources\MasterKepemilikanKendaraanResource\RelationManagers;
...
class MasterKepemilikanKendaraanResource extends Resource
{
    protected static ?string $model = MasterKepemilikanKendaraan::class;

    protected static ?string $navigationIcon = 'heroicon-o-truck';

    protected static ?string $navigationGroup = 'Master Data';

    protected static ?string $navigationLabel = 'Kepemilikan Kendaraan';
    ...
    {
        return [
            'index' => Pages\ListMasterKepemilikanKendaraans::route('/'),
            'create' => Pages\CreateMasterKepemilikanKendaraan::route('/create'),
            'edit' => Pages\EditMasterKepemilikanKendaraan::route('/{record}/edit'),
        ];
    }
}
