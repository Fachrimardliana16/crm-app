...
use App\Filament\Resources\MasterLokasiBangunanResource\Pages;
use App\Filament\Resources\MasterLokasiBangunanResource\RelationManagers;
...
class MasterLokasiBangunanResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Lokasi Bangunan';
    ...
    {
        return [
            'index' => Pages\ListMasterLokasiBangunans::route('/'),
            'create' => Pages\CreateMasterLokasiBangunan::route('/create'),
            'edit' => Pages\EditMasterLokasiBangunan::route('/{record}/edit'),
        ];
    }
}
