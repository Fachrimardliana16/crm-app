...
use App\Filament\Resources\MasterLuasTanahResource\Pages;
use App\Filament\Resources\MasterLuasTanahResource\RelationManagers;
...
class MasterLuasTanahResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Luas Tanah';
    ...
    {
        return [
            'index' => Pages\ListMasterLuasTanahs::route('/'),
            'create' => Pages\CreateMasterLuasTanah::route('/create'),
            'edit' => Pages\EditMasterLuasTanah::route('/{record}/edit'),
        ];
    }
}
